...
namespace Comos.Proteus
{
	...
	[Serializable]
	[XmlRoot("NormalDesignTemperature", Namespace="", IsNullable=false)]
	public class TemperatureDouble
	{
		...
		private TemperatureUnitsType unitsField;
		...
		[XmlAttribute]
		public TemperatureUnitsType Units
		{
			get
			{
